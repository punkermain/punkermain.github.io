...
legendsLink(legendsFindLink("дист"), 1000/speed);
}
if(legendsFindText("Цель")) {
if(kast == 0) legendsClick("удaрить", 1000/speed);
...
if(uuuu==1992) {
if(legendsFindText("Идёт бой")) {
legendsLink(legendsFindLink("дист"), 300/speed);
}
if(legendsFindText("Цель")) {
if(kast == 0) legendsClick("удaрить", 1000/speed);
if(kast == 1) legendsClick("кастовать", 1000/speed);
...
if(document.links[i].text.match('дист')) {
...
f=0;
if(f==0) {if(kast == 0) legendsClick("удaрить", 1000/speed);
if(kast == 1) legendsClick("кастовать", 1000/speed);}
}
if(legendsFindLink("Вещи под ногами")!="") {
legendsLink('http://velikozemie.ru/main.php?blok=veschy&do=2', 300/speed);
